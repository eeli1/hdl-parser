use hdl_parser::{n2t_hdl, Chip, ComponentMap};
    ...
    assert_eq!(
        ...
        Ok(vec![Chip::new(
            ...
            vec![
                ...
                ComponentMap::new(vec![("a", "a"), ("b", "ab_nand"), ("out", "a_nand")], "Nand"),
                ComponentMap::new(vec![("a", "b"), ("b", "ab_nand"), ("out", "b_nand")], "Nand"),
                ComponentMap::new(vec![("a", "a_nand"), ("b", "b_nand"), ("out", "out")], "Nand"),
            ]
        )])
    );
}
